...
program
  ...
  .action(() => {
    ...
    console.log(chalk.cyan('\n  Flags (work with both chat and ask):'))
    ...
    console.log(chalk.white('    -s, --search              ') + chalk.gray('Search the web to answer your question'))
    console.log(chalk.white('    -w, --write <path>        ') + chalk.gray('Write the response to a file'))
    console.log(chalk.white('    -g, --git                 ') + chalk.gray('Include git context (status, diff, log)'))
    ...
    console.log(chalk.cyan('\n  Mid-conversation flags (use inside atlas chat):'))
